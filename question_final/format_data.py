...
def format_data(data):
    ...
    for _, row in data.iterrows():
        ...
        prompt = (f"I am a student with a CGPA of {row['CGPA']}, and I have completed courses in "
                  ...
                  f"ML are {row['ML_Marks']}, and Microcontroller are {row['Microcontroller_Marks']}. Can you give me some "
                  f"insights on what career goals I should aim for based on my academic performance and interests? Can you suggest some "
                  f"relevant courses on Coursera or Udemy that align with my goals and interests with links?")
...
file_path = 'FlexStart\question_final\data\submissions.csv'  # <-- Replace with your actual file path
...
with open('FlexStart\question_final\llm_responses.txt', 'w') as f:
